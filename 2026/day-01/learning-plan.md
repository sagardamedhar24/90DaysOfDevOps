...
# About Me
I am a working professional with more than 6 years of experience in IT Industry,
...
- Learn DevOps skills from Scratch.
- Learn to build automation 
- Deploy at least one-two production grade applications, so that I can compete in interviewes with my current experience.

# 3 Core DevOps Skills I want to build
- To master the Linux, Shell scripting & Troubleshooting
- To learn and understand the Automation using ShellScript, Python, which is very important in DevOps role
- To build my cloud & container understanding (Docker, Kubernets & AWS/Azure)

# Weekly Time that I can allocate
Because, I am a working professional and family man, I have to give time to work+family as well. 
- Minimum 2 hours daily during weekdays (For understanding concepts & Hands On practices)
- On Weekends (Holiday), I will try to give 4-6 hours

# My End Goal 
To become proficient in DevOps role and aquire a job in DevOps Domain, for my future career growth.

# Consitency & Resources
- Learning through Live Session with TrainWithShubham DevOps Zero-to-Hero Udaan Batch 11
